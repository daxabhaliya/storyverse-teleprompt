...
export const Editor: React.FC = () => {
  ...
  return (
    <div className="editor-container glass" style={{ margin: 'auto', padding: '2rem', borderRadius: '12px', display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '100%', maxWidth: '800px', height: '70vh' }}>
